...
export function Hero({ language }: HeroProps) {
  ...
  const content = {
    en: {
      ...
      subtitle:
        'A premier international law firm with over 25 years of experience in corporate, civil, and cross-border litigation.',
      cta: 'Schedule Consultation',
    },
    so: {
      title: 'Adeeg Sharci oo Heer Caalami ah',
      subtitle:
        'Xafiis qareenno caalami ah oo leh waayo-aragnimo 25 sano ah oo ku aadan dacwadaha shirkadaha, madaniga ah, iyo kuwa ka baxsan xuduudaha.',
